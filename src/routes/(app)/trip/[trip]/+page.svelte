...
<TripView mode="trip" tripId={data.trip.id}>
	...
	<main class="grid w-full grid-cols-3 content-start gap-12 justify-self-center">
		...
		<!-- Flights -->
		<section class="grid w-full content-start gap-4">
		...
		<!-- Pack -->
		<section class="grid w-full content-start gap-4">
			<h2 class="font-header grid grid-cols-[1fr_auto] text-4xl font-bold">
