	...
	<li class="flex items-center gap-4">
		...
		>
			<label class="flex grow cursor-pointer flex-wrap gap-2"
				...
				/><span>{pack.item}</span>
				{#if pack.remark}<span class="text-base-content/70 font-light">({pack.remark})</span>{/if}
...
<TripView mode="pack" tripId={data.trip.id} tripName={data.trip.tripName}>
	{#snippet breadcrumbs()}
	...
	<div class="grid w-full grid-cols-2 content-start gap-8 justify-self-center">
					...
					<div class="collapse-content">
						<div class="flex flex-wrap gap-4 pt-4 text-sm">
							...
							<PackAddCommonItems
								...
								category="essentials"
							/>
							<PackAddCommonItems item="Credit cards" tripId={data.trip.id} category="essentials" />
				...
				<div class="collapse-arrow bg-base-100 border-base-content/20 collapse border">
					...
					<div class="collapse-content">
						<div class="flex flex-wrap gap-4 pt-4 text-sm">
							...
							<PackAddCommonItems item="Insect repellant" tripId={data.trip.id} category="health" />
							<PackAddCommonItems
